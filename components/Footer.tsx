...
const Footer = () => {
  return (
  <footer className="absolute w-screen bottom-0 py-3 flex items-center justify-center">
	<p>
		<span className="text-center pr-1.5 font-light">
			You are dope
		</span>
		<svg className="h-3.5 inline" preserveAspectRatio="xMidYMid meet" viewBox="36.07 8 27.71 84">
